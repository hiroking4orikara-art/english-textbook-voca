const hereWeGo3 = [
    ...
    },
    {
        ...
        "words": [
            ...
            { "en": "make", "jp": "[make + 人・もの + 動詞の原形] (人・ものに)～させる", "part": "verb" },
            { "en": "not all ~", "jp": "全てが～とは限らない", "part": "phrase" },
            { "en": "on the other hand", "jp": "一方で、他方では", "part": "phrase" },
            { "en": "other", "jp": "[the ~で](2つのうち)もう一方の、[the ~sで](3つ以上のうち)その他全ての", "part": "pronoun" },
    ...
    },
    {
        ...
        "pages": "P56〜60",
        "words": [
            { "en": "anything", "jp": "何も、どれも", "part": "pronoun" },
            { "en": "article", "jp": "記事", "part": "noun" },
            { "en": "develop", "jp": "～を開発する", "part": "verb" },
            { "en": "elderly", "jp": "年配の", "part": "adjective" },
            { "en": "expect", "jp": "～を期待する、求める", "part": "verb" },
            { "en": "facility", "jp": "施設", "part": "noun" },
            { "en": "finger", "jp": "手の指", "part": "noun" },
            { "en": "imagine", "jp": "～を想像する", "part": "verb" },
            { "en": "in addition", "jp": "その上", "part": "phrase" },
            { "en": "maintain", "jp": "～を保つ", "part": "verb" },
            { "en": "more and more", "jp": "ますます多くの", "part": "phrase" },
            { "en": "move", "jp": "～を動かす", "part": "verb" },
            { "en": "notice", "jp": "～に気づく", "part": "verb" },
            { "en": "physical", "jp": "身体の", "part": "adjective" },
            { "en": "real", "jp": "現実の、実在する", "part": "adjective" },
            { "en": "recognize", "jp": "～を認める", "part": "verb" },
            { "en": "scientist", "jp": "科学者", "part": "noun" },
            { "en": "sent", "jp": "send の過去形、過去分詞", "part": "verb" },
            { "en": "somebody", "jp": "誰か", "part": "pronoun" },
            { "en": "talk to ~", "jp": "～に話しかける", "part": "phrase" },
            { "en": "that way", "jp": "そのようにして", "part": "phrase" },
            { "en": "through", "jp": "～を通じて", "part": "preposition" },
            { "en": "useless", "jp": "役に立たない", "part": "adjective" },
            { "en": "dip", "jp": "～を(ちょっと)浸す", "part": "verb" },
            { "en": "drop", "jp": "しずく、1滴", "part": "noun" },
            { "en": "end", "jp": "(細長い物の)端、先端", "part": "noun" },
            { "en": "hard", "jp": "硬い", "part": "adjective" },
            { "en": "recipe", "jp": "レシピ、作り方", "part": "noun" },
            { "en": "sugar", "jp": "砂糖", "part": "noun" },
            { "en": "until", "jp": "～するまで(ずっと)", "part": "conjunction" },
            { "en": "Could you tell me how to ~?", "jp": "～のしかたを教えていただけますか。", "part": "phrase" },
            { "en": "add", "jp": "～を加える", "part": "verb" },
            { "en": "boil", "jp": "(～を)煮る、沸かす", "part": "verb" },
            { "en": "cool", "jp": "～を冷やす", "part": "verb" }
        ]
    },
    {
        "unit": "Unit 5 Part 1",
        ...
        "words": [
            ...
            { "en": "enough", "jp": "十分な、必要なだけの", "part": "adjective" },
    ...
    },
    {
        ...
        "words": [
            ...
            { "en": "those", "jp": "それらの、あれらの", "part": "adjective" },
    ...
    },
    {
        ...
        "words": [
            ...
            { "en": "bring back ~", "jp": "～を生き返らせる", "part": "phrase" },
            ...
            { "en": "yet", "jp": "[副] それでもまだ、依然として / [接] けれども、それにもかかわらず", "part": "adverb" },
    ...
    },
    {
        ...
        "words": [
            ...
            { "en": "goodbye", "jp": "[間] さようなら / [名] 別れの挨拶", "part": "noun" },
            ...
            { "en": "take a step forward", "jp": "一歩前に踏み出す", "part": "phrase" },
